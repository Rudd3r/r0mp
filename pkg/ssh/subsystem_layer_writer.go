...
func (s *SSHServer) handleLayerWriter(channel ssh.Channel, user string) {
	...
	var req domain.LayerWriteRequest
	if err := decoder.Decode(&req); err != nil {
		s.sendLayerResponse(channel, &domain.LayerWriteResponse{
			Success: false,
...
func (s *SSHServer) extractLayer(reader io.Reader, req domain.LayerWriteRequest) (int, error) {
...
func (s *SSHServer) sendLayerResponse(channel ssh.Channel, resp *domain.LayerWriteResponse) {
