...
func buildAndCreateInitrd(t *testing.T, testDir string, configFunc func(*initbuilder.InnitFSBuilder) error) string {
	t.Helper()
	...
	builder, err := initbuilder.NewInitFS(assets.Initrd(), customInitF)
